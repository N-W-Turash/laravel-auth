                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal auth-form" role="form" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label base-font label-text">E-Mail Address</label>
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            <label for="password" class="col-md-4 control-label label-text base-font label-text">Password</label>
